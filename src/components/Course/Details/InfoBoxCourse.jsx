  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 text-sm text-gray-700">
      <div className="flex items-center gap-2">
        ...
        <strong className="min-w-fit">Course duration:</strong>
        <div className="relative xl:min-h-5 w-2/3">
          {course ? <p>{course?.duration}</p> : <div className="skeleton" />}
        </div>
      </div>
      <div className="flex items-center gap-2">
        <MyIcons type={"level"} className="text-blue-600" />
        <strong className="min-w-fit">Level:</strong>
        <div className="relative xl:min-h-5 w-2/3">
      ...
      <div className="flex items-center gap-2">
        ...
        <strong className="min-w-fit">Teacher:</strong>
        <div className="relative xl:min-h-5 w-2/3">
          {course ? (
