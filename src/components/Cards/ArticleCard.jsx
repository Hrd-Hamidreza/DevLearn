...
export default function ArticleCard({ article = undefined }) {
  return (
    <div className="relative bg-white rounded-2xl shadow-md overflow-hidden transition hover:shadow-xl min-h-110">
      {!article ? (
